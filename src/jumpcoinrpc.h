...
#ifndef _JUMPCOINRPC_H_
#define _JUMPCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // jumpcoin is not connected
...
/**
 * jumpcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
