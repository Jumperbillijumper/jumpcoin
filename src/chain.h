...
enum BlockStatus: uint32_t {
    ...
    BLOCK_HAVE_DATA          =    8, //!< full block available in jump*.dat
...
public:
    ...
    //! Which # file this block is stored in (jump?????.dat)
    int nFile;

    //! Byte offset within jump?????.dat where this block's data is stored
