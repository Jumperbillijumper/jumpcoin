...
#ifndef H_JUMPCOIN_SCRIPT
#define H_JUMPCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CjumpcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, jumpcoin always counted CHECKMULTISIGs
