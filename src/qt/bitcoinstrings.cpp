...
QT_TRANSLATE_NOOP("bitcoin-core", "Imports blocks from external jump000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Rebuild chain state and block index from the jump*.dat files on disk"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: jumpcoin.conf)"),
