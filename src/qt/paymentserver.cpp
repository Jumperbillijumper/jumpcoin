...
const QString BITCOIN_IPC_PREFIX("jumpcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/jumpcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/jumpcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/jumpcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click jumpcoin: links
...
//
// OSX-specific way of handling jumpcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in jumpcoin: URIs
