...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless JumpCoin

See readme-qt.rst for instructions on building JumpCoin-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in JumpCoin
