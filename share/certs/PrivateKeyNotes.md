...
unlocked to sign the Jumpcoin-Qt.app bundle.
...
allowing somebody to distribute a Jumpcoin-Qt.app or jumpcoin-qt-setup.exe with a valid
...
that the jumpcoin-qt.exe file inside the installer had not been tampered with.
